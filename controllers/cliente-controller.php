 ...
 */
 class ClienteController extends MainController
 {
    ...
    */
    ...
    /*
    * CARREGAR EQUIPAMENTOS E FILIAIS PARA PLANTA BAIXA VIA JSON
    */
    public function carregarListaFilialClientePlantaBaixaJson(){
            ...
            if($listaEquip){
                ...
                foreach ($listaEquip as $equip) {
                    ...
                    $tabela         .="<tr>";
                        ...
                        $tabela         .="</td>";
                        $tabela         .="<td>";
                            $link       = HOME_URI."/monitoramento/monitorarPlantaBaixa/".$equip['id']."";
                            $tabela     .= "<a href='".$link."'><i class='fa fa-instagram fa-2x'></i></a>";
                        $tabela         .="</td>";
    ...
    */
    ...
    /*
    * CARREGAR EQUIPAMENTOS DE FILIAL ESPECIFICA PARA PLANTA BAIXA VIA JSON
    */
    public function carregarListaEquipamentoFilialPlantaBaixaJson(){
    ...
    */
    ...
    /*
    * CARREGA LISTA DE EQUIPAMENTOS POR CLIENTE, FILIAL, TIPO PARA PLANTA BAIXA
    */
    public function carregarListaEquipamentoFilialTipoPlantaBaixaJson(){
        // CARREGA O MODELO PARA ESTE VIEW/OPERAÇÃO
        $equipeModelo   = $this->load_model('equipamento/equipamento-model');
