...
<script>
    ...
    */
    ...
    <?php
        ...
        $time = explode(",", $modelo->respDate);

        $inicioData = str_replace ("["," ",$time[0]);
        $fimData    = str_replace ("]"," ",end($time));
    ?>
...
<div class="container-fluid">
    ...
    <div class="row">
        <h4 class="text-header"> Novo gráfico</h4>
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="demo-container">
                			<div id="placeholder" class="demo-placeholder col-md-12" style="height:450px;"></div>
                		</div >
                    </div>
                    <div class="row">
                        <div id="overview" class="col-md-12" style="height:250px;">
