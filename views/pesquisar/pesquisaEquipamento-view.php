...
$retorno = $modelo->pesquisaRelacao(3);
...
<script type="text/javascript">
    ...
    menu.innerHTML = '<a href="<?php echo HOME_URI; ?>/home/" class="linkMenuSup">Home</a> / <a href="<?php echo HOME_URI; ?>/pesquisar/equipamentocadastrado/" class="linkMenuSup">Editar Equipamento</a>';
</script>
...
<script id="template" type="text/html">
    <tr>
        ...
        <td class="tdsec txt-center">
            <a href="<?php echo HOME_URI; ?>/editar/editarEquipamento/{{record.codigo}}" class="link-tabela-moni">
