...
$retorno = $modelo->pesquisaRelacao(1);
...
<script type="text/javascript">
    ...
    menu.innerHTML = '<a href="<?php echo HOME_URI; ?>/home/" class="linkMenuSup">Home</a> / <a href="" class="linkMenuSup">Editar Filial</a>';
</script>
...
<script id="template" type="text/html">
    <tr>
        <td class="tdprim">
            <a href="<?php echo HOME_URI; ?>/editar/editarFilial/{{record.codigo}}" class="link-tabela-moni">
                {{record.nome}}
            </a>
        </td>
