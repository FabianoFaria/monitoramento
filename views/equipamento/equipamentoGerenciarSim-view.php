                    ...
                    <form id="filtroChips" method="post">
                        ...
                        <div class="col-md-3 form-group">
                            <div class="" style="margin-top:15px;">
                                <p>
                                    <button class="btn btn-primary" id="adicionarNovoChipSim" >
                                        <i class="fa fa-plus fa-lg"> </i>Adicionar novo chip SIM
                                    </button>
                                </p>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Número do chip SIM</label>

                                <input type="text" class="form-control" id="txt_chip_number" name="txt_chip_number" placeholder="Número Chip" value="">
                            </div>
                        </div><!-- fim número SIM -->

                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Telefone do chip SIM</label>

                                <input type="text" class="form-control" id="txt_telefone_number" name="txt_telefone_number" placeholder="Telefone Chip" value="">
                            </div>
                        </div><!-- fim telefone -->

                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Modelo do chip SIM : Verde/Vermelho</label>

                                <input type="text" class="form-control" id="txt_chip_modelo" name="txt_chip_modelo" placeholder="Modelo chip" value="">
                            </div>
                        </div><!-- fim modelo -->
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Versão do projeto</label>

                                <input type="text" class="form-control" id="txt_vercao_projeto" name="txt_vercao_projeto" placeholder="Modelo chip" value="">
                            </div>
                        </div><!-- fim modelo -->
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="cadastrarDadosSimBtn">Cadastrar novo chip</button>
            </div>
        </div>
    </div>
</div>
