...
(function(window, $) {
  ...
  _F.addSearchBox = function(){
    ...
    $(this.main_container).before('<div class="col-md-4 col-md-offset-6"><div class="form-group"><label for="exampleInputEmail1">Procurar por</label><input name="search" type="text" id="st_search" class="form-control" placeholder="Procurar por..."></div></div>');
  ...
  _F.addPerPage = function(){
    ...
    html = ['<div class="col-md-2"><div class="form-group"><label for="exampleInputEmail1">Resultados</label><select name="per_page" class="form-control '+ this.paging_opts.per_page_class +'">'];
